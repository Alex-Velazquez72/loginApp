...
<script setup>
import { ref } from "vue"; 
import { getAuth, createUserWithEmailAndPassword, signInWithPopup, GoogleAuthProvider } from "firebase/auth"; // Métodos de Firebase Auth
...
const signInWithGoogle = async () => {
  ...
  try {
    ...
    router.push("/Feed"); // Redirige al feed tras iniciar sesión con éxito
  } catch (error) {
